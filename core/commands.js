...
function loadCommands() {
    ...
    for (const file of files) {
        try {
            ...
            if (cmd.name && typeof cmd.execute === 'function') {
                ...
                if (process.env.PHOENIX_VERBOSE === 'true') console.log(`✅ Commande chargée : ${cmd.name}`);
            }
        } catch (e) {
    ...
    if (process.env.PHOENIX_VERBOSE === 'true') console.log(`🥷 ${uniqueCommands.size} commande(s) chargée(s) : ${cmdList}`);
}
