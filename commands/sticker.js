...
module.exports = {
    ...
    async execute(sock, msg, botState, ctx) {
        ...
        if (!mediaMsg) {
            await sock.sendMessage(myJid, { text: '╭━━━〔 🎨 STICKER 〕━━━╮\n┃ ⚠️ Envoie une image ou une vidéo\n┃ avec `!sticker [position] [texte]`\n┃ Positions : haut, centre, bas\n╰━━━━━━━━━━━━━━━━━━━╯' });
            return;
        }
        ...
        try {
            ...
            if (stickerBuffer.length > 1024 * 1024) {
                await sock.sendMessage(myJid, { text: `⚠️ Sticker trop volumineux (${(stickerBuffer.length / 1024).toFixed(0)} Ko).\n📦 Limite WhatsApp : 1 Mo.` });
                return;
            }
            ...
            await sock.sendMessage(myJid, { text: `⚠️ La création du sticker a échoué.\n_Raison : ${e.message}_` });
        } finally {
